...
public class TimeTableController implements ITimeTableController {
	...
	public String getTeacherLogin(int timeTableId, int bookId) {
        Iterator<TimeTable> ItTT = timeTableModel.TimeTableDB.TimeTableSet.iterator();// CrÈation d'un itÈrateur pour parcourir TimeTableSet
        while(ItTT.hasNext()){
    ...
    public boolean removeTimeTable(int timeTableId) {
        Iterator<TimeTable> ItTT = timeTableModel.TimeTableDB.TimeTableSet.iterator() ;    // CrÈation d'un itÈrateur pour parcourir RoomsSet
        while(ItTT.hasNext()){
    ...
    public boolean addBooking(int timeTableId, int bookingId, String login, Date dateBegin, Date dateEnd, int roomId) {
        ...
        //TimeTable NewTT = new TimeTable (timeTableId);
        Iterator<TimeTable> ItTT = timeTableModel.TimeTableDB.TimeTableSet.iterator() ;    // CrÈation d'un itÈrateur de timetable
	...
	public int getBookingsMaxId(int timeTableId){
        int max = 0;
        HashSet<TimeTable> TTSet = TimeTableDB.TimeTableSet;
        Iterator<TimeTable> it1 = TimeTableDB.TimeTableSet.iterator();   // Premier itÈrateur pour parcourir les TimeTable
        while(it1.hasNext()){
            TimeTable TT=(TimeTable)it1.next();
